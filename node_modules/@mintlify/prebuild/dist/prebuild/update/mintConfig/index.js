...
export async function updateMintConfigFile(contentDirectoryPath, openApiFiles, localSchema, strict, invalidSpecFiles) {
    ...
    const { mintConfig: newMintConfig, pagesAcc, openApiFiles: newOpenApiFiles, } = await generateOpenApiAnchorsOrTabs(mintConfig, openApiFiles, undefined, localSchema, invalidSpecFiles);
